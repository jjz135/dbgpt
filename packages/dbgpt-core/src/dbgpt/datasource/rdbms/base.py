...
class RDBMSConnector(BaseConnector):
    ...
    def __init__(
        ...
        try:
            ...
            # Handle compatibility issues with databases migrated from SQL Server to MySQL
            # Some table names or structures may cause reflection to fail
            logger.warning(f"Metadata reflection failed, continuing with limited functionality: {e}")
            # Continue without full metadata reflection to allow basic connection testing
