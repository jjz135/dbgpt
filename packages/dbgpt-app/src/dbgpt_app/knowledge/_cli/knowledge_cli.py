...
@click.option(
    ...
    required=True,
    type=str,
    help="Current knowledge space name",
)
@click.option(
    "--new_name",
    required=True,
    type=str,
    help="New knowledge space name",
)
@click.option(
    "-y",
    required=False,
    ...
    default=False,
    is_flag=True,
    help="Confirm your choice without prompting",
)
def rename(old_name: str, new_name: str, y: bool):
    """Rename a knowledge space"""
    from dbgpt_app.knowledge._cli.knowledge_client import knowledge_rename

    knowledge_rename(API_ADDRESS, old_name, new_name, confirm=y)
