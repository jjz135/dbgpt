...
const PlainMarkdown: React.FC<{ children?: string }> = ({ children }) => {
            ...
            children: (
              <div className='flex gap-4'>
                <Card size='small' title={t('Main_content')} className='w-2/3 flex-wrap overflow-y-auto'>
                  <PlainMarkdown>{currentChunkInfo?.content}</PlainMarkdown>
                </Card>
                <Card size='small' title={t('Auxiliary_data')} className='w-1/3'>
                  <PlainMarkdown>{currentChunkInfo?.meta_info}</PlainMarkdown>
                </Card>
              </div>
            ),
          },
