...
import { STORAGE_LANG_KEY, STORAGE_THEME_KEY, STORAGE_USERINFO_KEY, STATIC_DISPLAY_NAME, LOGO_IMAGE_PATH, LOGO_SMALL_IMAGE_PATH, LOGO_DARK_IMAGE_PATH } from '@/utils/constants/index';
...
function SideBar() {
  ...
  const [logo, setLogo] = useState<string>(LOGO_IMAGE_PATH);
  ...
  useEffect(() => {
    setLogo(mode === 'dark' ? LOGO_DARK_IMAGE_PATH : LOGO_IMAGE_PATH);
  }, [mode]);
      ...
      >
        <div>
          <Link href='/' className='flex justify-center items-center pb-4'>
            <Image src={isMenuExpand ? logo : LOGO_SMALL_IMAGE_PATH} alt={STATIC_DISPLAY_NAME} width={40} height={40} />
          </Link>
    ...
    >
      <div>
        ...
        <Link href='/' className='flex items-center justify-center p-2 pb-4'>
            <Image src={isMenuExpand ? logo : LOGO_SMALL_IMAGE_PATH} alt={STATIC_DISPLAY_NAME} width={180} height={40} />
        </Link>
        {/* functions */}
